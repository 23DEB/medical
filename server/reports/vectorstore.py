...
if PINECONE_INDEX_NAME in existing_indexes:
    try:
        ...
        if index_info.dimension != 384:
            print(f"Deleting existing index with wrong dimension: {index_info.dimension}")
...
if PINECONE_INDEX_NAME not in pc.list_indexes().names():
    pc.create_index(
        name=PINECONE_INDEX_NAME, dimension=384, metric="dotproduct", spec=spec
    )
...
async def load_vectorstore(
    ...
    # Local HuggingFace embeddings (same as your reference code)
